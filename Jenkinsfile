        ...
        steps {
          ...
          script {
            step([$class: "RundeckNotifier",
              ...
              jobId: "dc065b32-1c35-41cd-b9c7-e3e38087ed2c",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
          ...
          script {
            step([$class: "RundeckNotifier",
              includeRundeckLogs: true,
              jobId: "b45f8a28-90e3-4b6a-abb4-f593ce9a5cf0",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
         ...
         sh 'echo Deploying ambiente homologacao'
          ...
          script {
            step([$class: "RundeckNotifier",
              ...
              //JOB DE BUILD
              jobId: "8af3acfd-547b-4b77-bab8-ca16b5b3e270",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
          ...
          script {
            step([$class: "RundeckNotifier",
              includeRundeckLogs: true,
              jobId: "c87547a3-ffcd-44db-a8d9-86e73e6b11d4",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
        ...
        steps {
          ...
          script {
            step([$class: "RundeckNotifier",
              ...
              //JOB DE BUILD
              jobId: "7debd03d-364d-48ea-892f-c86aebd4896a",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
               //    PARAM_2=value2
          ...
          script {
            step([$class: "RundeckNotifier",
              includeRundeckLogs: true,
              jobId: "ddb1066d-0f57-42c8-a11a-8da2f0e2272a",
              nodeFilters: "",
              //options: """
              //     PARAM_1=value1
              //    PARAM_2=value2
